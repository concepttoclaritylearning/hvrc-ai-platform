...
const SHOW_METRICS_KEY = "HVRC.AI_show_chat_metrics";
const SHOW_METRICS_EVENT = "HVRC.AI_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `HVRC.AI_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `HVRC.AI_show_chat_metrics` key
 * @returns {void}
 */
