...
const System = {
  cacheKeys: {
    footerIcons: "HVRC.AI_footer_links",
    supportEmail: "HVRC.AI_support_email",
    customAppName: "HVRC.AI_custom_app_name",
    canViewChatHistory: "HVRC.AI_can_view_chat_history",
    deploymentVersion: "HVRC.AI_deployment_version",
  },
  ping: async function () {
