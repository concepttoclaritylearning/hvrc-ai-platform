...
https://github.com/HVRC-Labs/HVRC.AI-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/HVRC.AI-chat-widget.min.js">
</script>
<!-- HVRC.AI (https://HVRC.AI.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/HVRC-Labs/HVRC.AI-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
