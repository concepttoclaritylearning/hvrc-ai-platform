...
export const ONBOARDING_SURVEY_URL = "https://hvrc.ai";

export const AUTH_USER = "hvrc_ai_user";
export const AUTH_TOKEN = "hvrc_ai_authToken";
export const AUTH_TIMESTAMP = "hvrc_ai_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "hvrc_ai_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "hvrc_ai_pinned_document_alert";
export const SEEN_WATCH_ALERT = "hvrc_ai_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "hvrc_ai_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "hvrc_ai_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "hvrc_ai_pending_home_message";

export const APPEARANCE_SETTINGS = "hvrc_ai_appearance_settings";
