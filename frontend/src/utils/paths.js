...
export default {
  ...
  github: () => {
    return "https://github.com/HVRC-Labs/hvrc-ai";
  },
  discord: () => {
    return "https://discord.com/invite/6UyHPeGZAC";
  },
  docs: (path = "") => {
    return `https://docs.HVRC.AI.com${path}`;
  },
  chatModes: () => {
    return "https://docs.HVRC.AI.com/features/chat-modes";
  },
  mailToHVRC: () => {
    return "mailto:team@hvrc.com";
  },
  hosting: () => {
    return "https://hvrc.ai/aio-checkout?product=HVRC.AI";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.HVRC.AI.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.HVRC.AI.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.HVRC.AI.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.HVRC.AI.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
